module BenchPressWeightRecordsHelper
  ...
  def bench_press_chart_graph(user, range)
    ...
    line_chart user.bench_press_weight_records.group_by_day(:bench_press_day, range: range, series: false).average(:bench_press_weight), min: chart_min, max: chart_max, points: false, colors: ['orange']
  end
