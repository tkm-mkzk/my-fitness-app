document.addEventListener('turbolinks:load', function() {
  const daily_btn = document.getElementById("daily-squat-chart-btn");
  const weekly_btn = document.getElementById("weekly-squat-chart-btn");
  const monthly_btn = document.getElementById("monthly-squat-chart-btn");
  const daily_chart = document.getElementById("daily-squat-chart");
  const weekly_chart = document.getElementById("weekly-squat-chart");
  const monthly_chart = document.getElementById("monthly-squat-chart");
